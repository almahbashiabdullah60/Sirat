...
import com.atyafcode.sirat.data.repository.AppLockRepository.Companion.shouldStartService
...
import com.atyafcode.sirat.shizuku.ShizukuActivityManager
...
class ShizukuAppLockService : Service() {
    ...
    private fun createNotification(): Notification {
        return NotificationCompat.Builder(this, CHANNEL_ID)
            ...
            .setContentText(getString(R.string.shizuku_service_notification_desc))
