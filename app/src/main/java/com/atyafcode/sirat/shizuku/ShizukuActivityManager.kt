package com.atyafcode.sirat.shizuku
...
import com.atyafcode.sirat.core.broadcast.DeviceUnlockReceiver
...
import com.atyafcode.sirat.services.isDeviceLocked
...
class ShizukuActivityManager(
    ...
    private fun checkForegroundApp() {
        ...
        getTasksWrapper().filterVisible().forEach {
            ...
            // then trigger sirat for any new foreground app
            ...
            if (packageName != lastForegroundApp) {
                ...
                if (lastForegroundApp in triggerExclusions) {
                    LogUtils.d(
                        TAG,
                        "Previous app $lastForegroundApp is excluded, skipping sirat for $packageName"
                    )
                    lastForegroundApp = packageName
                    return
                }
